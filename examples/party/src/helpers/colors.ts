...
export const getColorsBySeasonalAssociation = (season: string) => 
        getAllTraditionalColors().filter(color => color.seasonalAssociation === season)

export const getColorsByElement = (element: string) =>
        CHINESE_COLORS_DATA.filter(color => color.element === element)
