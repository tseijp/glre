...
import { GLTFImagePostprocessed, GLTFLoader, postProcessGLTF } from '@loaders.gl/gltf'
...
/**
 * Parse glTF/GLB with @loaders.gl/gltf, including JPEG/PNG textures.
 */
export const parseGLB = async (buf: ArrayBuffer) => {
