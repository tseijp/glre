        ...
        const gl = useGL(
                {
                        ...
                        in vec2 a;
                        void main() {
                                gl_Position = vec4((vec2(-0.5, 0.0) + a), 0.0, 1.0);
                        }\`,
                },
                {
                        triangleCount: 1,
                        ...
                        in vec2 b;
                        void main() {
                                gl_Position = vec4((vec2(0.5, 0.0) + b), 0.0, 1.0);
                        }\`,
                }
        )
        gl.attribute('a', [0, 0.37, -0.5, -0.5, 0.5, -0.5])
        gl.attribute('b', [0, -0.37, -0.5, 0.5, 0.5, 0.5])
        return <canvas ref={gl.ref} />
}`}
                />
        </TabItem>
        ...
        const gl = useGL(
                {
                        ...
                        fn main(in: In) -> Out {
                                var out: Out;
                                out.position = vec4f((vec2f(-0.5, 0.0) + in.a), 0.0, 1.0);
                                return out;
                        }\`,
                },
                {
                        ...
                        fn main(in: In) -> Out {
                                var out: Out;
                                out.position = vec4f((vec2f(0.5, 0.0) + in.b), 0.0, 1.0);
                                return out;
                        }\`,
                }
        )
