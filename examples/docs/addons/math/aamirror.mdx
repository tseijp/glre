---
title: 'Anti-Aliased Mirror Function'
...
The function implements a sophisticated mirroring algorithm that:

- Transforms input into symmetric patterns around 0.5 intervals
- Applies automatic derivative-based anti-aliasing
- Produces continuous, smooth transitions without aliasing artifacts
- Maintains perfect symmetry across mirror boundaries
...
The `aamirror` function integrates seamlessly with:
