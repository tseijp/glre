---
title: 'Atan2: Two-Argument Arctangent Function'
...
The function takes two parameters: y (vertical displacement) and x (horizontal displacement). The result represents the counter-clockwise angle from the positive x-axis to the point.
