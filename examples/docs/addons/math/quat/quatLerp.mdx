...
const fragment = () => {
        ...
        const qb = vec4(sin(1.57), 0, 0, cos(1.57)).normalize()
        ...
        const pattern = sin(rotated.x.mul(rotated.y).mul(6)).abs()
...
const fragment = () => {
        ...
        const q2 = vec4(sin(hash.mul(3.14)), 0, 0, cos(hash.mul(3.14))).normalize()
        const q3 = vec4(0, sin(hash.mul(1.57)), 0, cos(hash.mul(1.57))).normalize()
        const q4 = vec4(0, 0, sin(hash.mul(2.35)), cos(hash.mul(2.35))).normalize()
