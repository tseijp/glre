---
title: 'Bump: Smooth Falloff Functions'
...
The basic formula uses `1 - x²` which creates a smooth parabolic curve. Adding a threshold parameter `k` allows fine control over the falloff curve steepness.
