...
### Exercise 1: Rain Effect

Create realistic raindrops and puddle reflections.

### Exercise 2: Explosion Effect

Create a staged explosion (shockwave → sparks → smoke).

### Exercise 3: Magic Effect

Create an effect combining light particles with magic circles.
...
// Solution: Dynamic count adjustment
