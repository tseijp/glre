...
| ----- | --------------------------------------------------------------- | ------------------------------------------ |
| **1** | [Getting Started](fundamentals/01-getting-started.mdx)           | Environment setup and first steps          |
| **2** | [Colors and Coordinates](fundamentals/02-colors-coordinates.mdx) | Color specification and screen coordinates |
| **3** | [Time and Animation](fundamentals/03-time-animation.mdx)         | Creating dynamic visual expressions        |
...
| Step  | Topic                                                       | What You'll Learn                   |
| ----- | ----------------------------------------------------------- | ----------------------------------- |
| **4** | [Shapes and Patterns](techniques/04-shapes-patterns.mdx)     | Basic shapes and repeating patterns |
| **5** | [Images and Textures](techniques/05-images-textures.mdx)     | Loading and processing images       |
| **6** | [Interactive Effects](techniques/06-interactive-effects.mdx) | Responding to mouse and keyboard    |
...
When you're ready, start with [Getting Started](fundamentals/01-getting-started.mdx) to begin your journey.
