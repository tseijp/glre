...
describe('Operator Chain', () => {
        ...
        describe('Comparison operators', () => {
                it('returns bool type', () => {
                        const x = float(1).lessThan(float(2))
                        const y = vec2(1, 2).equal(vec2(1, 2))
        ...
        describe('Swizzle operations', () => {
                it('component access', () => {
                        const x = position.xyz
                        const y = position.xyz.xy
                        const z = position.xyz.xy.x
                ...
                it('mixed operations', () => {
                        const x = vec3(1, 2, 3).xy.mul(float(2))
                        const y = vec3(1, 2, 3).add(vec3(4, 5, 6)).xyz
